...
public class Fading : MonoBehaviour {
	...
	public Texture2D fadeOutTexture;						//the texture that will overlay the sceen. Black image or a loading graphic
	...
	void OnGUI(){
		...
		GUI.DrawTexture (new Rect (0, 0, Screen.width, Screen.height), fadeOutTexture);		// draw the texture to fit the entire sceen area
	}
